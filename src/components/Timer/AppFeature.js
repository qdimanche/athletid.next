...
import Tempo from "../../../public/images/application-timer-tempo.webp";
import Intervalle from "../../../public/images/application-timer-intervalle.webp";
import Breath from "../../../public/images/application-timer-respiration.webp";
        ...
        <div className={"flex items-center space-x-16"}>
          ...
          >
            {countTab === 1 ? (
              ...
              <img src={Intervalle} className={"object-contain"} alt="" />
            ) : (
              <img src={Breath} className={"object-contain"} alt="" />
            )}
          </div>
