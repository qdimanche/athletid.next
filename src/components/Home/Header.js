    ...
    return (
        ...
        >
            <div
                ...
                className={
                    'lg:mt-0 lg:mt-3 flex md:grid md:grid-cols-2 flex-col  z-[3] lg:p-0 items-center'
                }
            >
                <div
                    className={clsx(
                        'max-w-[1280px] lg:px-16 md:px-8 px-4 mx-auto pt-28 md:pt-28 md:pr-8 md:py-16 w-screen md:flex md:flex-col md:justify-center',
            ...
            >
                <a target={'_blank'} href={"https://www.instagram.com/timerbyathletid/"} rel="noreferrer">
