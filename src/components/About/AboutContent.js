...
const AboutContent = () => {
    return (
        <div
            className={'2xl:mt-[15rem]  lg:!my-8  border-b border-white/10 overflow-x-hidden mt-4 mb-16'}>
            ...
            <div
                className={'lg:h-[60vh] h-[35vh] rounded-medium relative overflow-hidden flex mb-0  safari-overflow-fix'}>
