...
const DownloadApp = (props, ref) => {
    return (
        <div ref={ref} className={`flex ${props.flexDirection} ${props.marginBottom} text-center items-center`}>
            ...
            <div className={`flex ${props.justifyContent} space-x-4 !w-full`}>
                ...
                >
                    <DownloadPlayStore
                        width={162}
                        height={50}
                        className={"hover:fill-white duration-300 rounded-[9px] hover:bg-black "}
                    />
                </a>
                <a
                    target={"_blank"}
