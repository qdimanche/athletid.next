...
const CarouselBgImage = () => {
    ...
    return (
        <div className={'lg:my-40 my-28 h-[800px] relative'}>
            ...
            <div className={'absolute bottom-8 right-8 flex w-full justify-end space-x-8'}>
                <div
                    className={
                        `w-[55px] h-[55px] border ${isPrevious ? 'border-timeRed' : 'border-white'} rounded-full flex items-center justify-center`
                    }
                >
                    <BsArrowLeft
                        size={20}
                ...
                <div
                    className={`w-[55px] h-[55px] border ${isNext ? 'border-timeRed' : 'border-white'}  rounded-full flex items-center justify-center`}
                >
                    <BsArrowRight
                        size={20}
                        color={'white'}
