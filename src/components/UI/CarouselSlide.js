        ...
        >
            <div className={'pb-16'}>
                <div className="slide rounded-[30px] overflow-hidden bg-[#F2F2F2] px-8 pt-8">
                    <Image alt="sample_file" src={props.imgSquare1} className={'h-[400px]'}/>
                </div>
                <p className="legend absolute !bottom-0 !text-black !bg-white !h-16">{props.titleSquare1}</p>
            </div>
            <div className={'pb-16'}>
                <div className="slide rounded-[30px] overflow-hidden bg-[#F2F2F2] px-8 pt-8">
                    <Image alt="sample_file" src={props.imgSquare2} className={'h-[400px]'}/>
                </div>
                <p className="legend absolute !bottom-0 !text-black !bg-white !h-16">{props.titleSquare2}</p>
            </div>
            <div className={'pb-16'}>
                <div className="slide rounded-[30px] overflow-hidden bg-[#F2F2F2] px-8 pt-8">
                    <Image alt="sample_file" src={props.imgSquare3} className={'h-[400px]'}/>
                </div>
